...
"[project]/Desktop/frontend/node_modules/thirdweb/dist/esm/transaction/actions/gasless/send-gasless-transaction.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function sendGaslessTransaction({ account, transaction, serializableTransaction, gasless }) {
    ...
    if (gasless.provider === "biconomy") {
        const { relayBiconomyTransaction } = await __turbopack_context__.A("[project]/Desktop/frontend/node_modules/thirdweb/dist/esm/transaction/actions/gasless/providers/biconomy.js [app-client] (ecmascript, async loader)");
    ...
    if (gasless.provider === "openzeppelin") {
        const { relayOpenZeppelinTransaction } = await __turbopack_context__.A("[project]/Desktop/frontend/node_modules/thirdweb/dist/esm/transaction/actions/gasless/providers/openzeppelin.js [app-client] (ecmascript, async loader)");
    ...
    if (gasless.provider === "engine") {
        const { relayEngineTransaction } = await __turbopack_context__.A("[project]/Desktop/frontend/node_modules/thirdweb/dist/esm/transaction/actions/gasless/providers/engine.js [app-client] (ecmascript, async loader)");
...
//# sourceMappingURL=1b50e_thirdweb_dist_esm_transaction_actions_gasless_send-gasless-transaction_a712e1df.js.map