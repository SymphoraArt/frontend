# Enki — The Premium Prompt Marketplace

Enki is a high-fidelity creative marketplace and AI generation platform designed for modern art direction. It enables artists to discover, refine, and generate stunning AI-generated visuals using a variable-based prompt system.
...
Unlike standard marketplaces, Enki uses a "bracket system" (e.g., `[subject]`, `[mood]`) allowing users to customize prompt templates before generation.
