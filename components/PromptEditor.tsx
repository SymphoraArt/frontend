                        ...
                        <TooltipProvider key={index}>
                          <Tooltip delayDuration={200}>
                            <TooltipTrigger asChild>
                              <span
                                className={`select-none cursor-pointer pointer-events-auto inline-flex items-center rounded px-1 py-0.5 mx-0.5 font-mono font-medium bg-primary/20 text-primary border border-primary/30 hover:bg-primary/25 ${isOpen ? "ring-2 ring-primary/50" : ""}`}
                                onClick={(e) => {
                                  e.preventDefault();
                      ...
                      >
                        ...
                        {openVariables.includes(variable.id) && (
                          ...
                          <Button
                            ...
                            className="w-full"
                            disabled={variable.required && !variable.label.trim()}
