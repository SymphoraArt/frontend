...
import { HUNT_SHARE_PCT } from "@/shared/revenue-config";
      ...
      <PopoverContent className="w-80 p-4" align="end" sideOffset={8}>
        <div className="flex items-center gap-2 mb-2">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-64 p-3 bg-popover border text-popover-foreground text-xs rounded-md shadow-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
              ...
              If approved, you earn {HUNT_SHARE_PCT}% of the artist's revenue every time someone generates with it, until the original artist connects their socials and claims the account. Then the payout transfers to them and you'll receive artist fan points for potential goodies.
            </div>
          </div>
        </div>
        ...
        {status === "success" ? (
          <div className="flex flex-col items-center justify-center py-4 text-center">
            ...
            <p className="text-xs text-muted-foreground mt-1">You'll earn {HUNT_SHARE_PCT}% of generations once accepted.</p>
          </div>
        ) : (
          <div className="flex flex-col gap-3">
            <p className="text-xs text-muted-foreground">
              Enter the URL of an X or Instagram post to claim {HUNT_SHARE_PCT}% affiliate earnings.
            </p>
            <div>
              <input
                type="text"
