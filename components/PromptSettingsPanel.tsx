            ...
            <Select
              ...
              onValueChange={(value) => {
                if (value && !settings.tags.includes(value)) {
                  onUpdate({ tags: [...settings.tags, value] });
                }
              }}
            >
              <SelectTrigger className="h-8 text-sm" data-testid="select-tags">
                <SelectValue placeholder="Select tags..." />
              </SelectTrigger>
              <SelectContent>
                {["Nature", "Portrait", "Abstract", "Sci-Fi", "Fantasy", "Architecture", "Landscape", "Urban", "Animal", "Food", "Travel", "Fashion", "Product", "Concept Art", "Digital Art"].filter(tag => !settings.tags.includes(tag)).map((tag) => (
