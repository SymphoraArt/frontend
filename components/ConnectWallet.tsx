...
interface ConnectWalletProps {
  /** Optional extra class for the connect button (e.g. green primary style in Quick Create). */
  ...
  return (
    <ConnectButton
      ...
      connectButton={{
        ...
        className: ["connect-wallet-button", buttonClassName].filter(Boolean).join(" "),
      }}
