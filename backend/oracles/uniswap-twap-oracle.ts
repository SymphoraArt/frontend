...
import { createThirdwebClient, getContract, readContract, type ThirdwebClient } from "thirdweb";
import { defineChain } from "thirdweb/chains";
import { PAYMENT_CHAINS, type ChainKey } from "@/backend/config/blockchain";
 ...
 */
export interface UniswapOracleErrorDetails {
  tokenSymbol?: string;
  chain?: ChainKey;
  deviationFromSpot?: number;
  maxDeviation?: number;
...
export class UniswapOracleError extends Error {
  constructor(
    ...
    public readonly details?: UniswapOracleErrorDetails
  ) {
    super(message);
