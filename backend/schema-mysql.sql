-- Symphora database schema for MySQL
...
-- ----------------------------
-- symphora_prompts: marketplace (paid/free) and showroom (showcase) prompts
-- prompt_data stores encrypted segments and variable definitions as JSON (same structure as current app)
-- ----------------------------
CREATE TABLE IF NOT EXISTS symphora_prompts (
  ...
  prompt_data JSON NOT NULL COMMENT 'segments (encrypted content: encrypted, iv, authTag) and variables',
...
-- ----------------------------
-- symphora_prompt_likes: one like per user per prompt
-- ----------------------------
...
-- ----------------------------
-- symphora_generations: user generations (final prompt encrypted, variable values, image url, status)
-- ----------------------------
...
-- ----------------------------
-- symphora_users: optional user profiles (wallet addresses encrypted in Phase 2 / MongoDB)
-- ----------------------------
