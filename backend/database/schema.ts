...
export const generationSchema = z.object({
  ...
  finalPrompt: z.string(), // Encrypted final prompt after variable substitution (base64)
  finalPromptIv: z.string(), // Initialization vector for encryption (base64)
  finalPromptAuthTag: z.string(), // Authentication tag for GCM mode (base64)
