...
export async function GET(
  ...
  try {
    ...
    // Build response (Supabase may use user_key or user_id)
    const response: any = {
      id: data.id,
      userId: data.user_key ?? data.user_id,
    ...
    // Optionally decrypt final prompt (iv/authTag stored with encrypted content)
