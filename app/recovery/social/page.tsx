...
import { Shield, Key, AlertCircle, Clock, Users, User, Mail, Link } from "lucide-react";
    ...
    return (
      <div style={{ minHeight: "100vh", background: CREAM, fontFamily: FONT, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
        <div style={{ width: "100%", maxWidth: 520, background: "#fff", border: `1px solid ${BORDER}`, borderRadius: 12, padding: 28 }}>
          <Label c="Social recovery disabled" />
          <H c="This flow is not live yet." />
          <Sub c="Guardian approvals, timelocks, cancellation, and proof checks are currently UI simulations. The route is disabled until those checks run on the server." />
