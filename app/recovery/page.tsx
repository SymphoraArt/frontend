    ...
    return (
      <div style={{ minHeight: "100vh", background: CREAM, fontFamily: FONT, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
        <div style={{ width: "100%", maxWidth: 520, background: "#fff", border: `1px solid ${BORDER}`, borderRadius: 12, padding: 28 }}>
          <Label>Recovery disabled</Label>
          <H2>Recovery is not live yet.</H2>
          <Sub>These recovery screens are UI prototypes until the Turnkey and Supabase verification APIs are wired. Use normal wallet sign-in or Settings → Recovery & 2FA → Register passkey.</Sub>
